...
BUILD_MAP_SIZE_X, BUILD_MAP_SIZE_Y = 20, 16
BUILD_MAP_EDGE_X, BUILD_MAP_EDGE_Y = 6, 8
FRAME_MOVE = 32
...
def get_build_tile_position_x(current_position_x):
    build_tile_x = int((current_position_x - BUILD_MAP_EDGE_X * BUILD_TILE_WIDTH) / BUILD_TILE_WIDTH)
    return build_tile_x


def get_build_tile_position_y(current_position_y):
    build_tile_y = int((current_position_y - BUILD_MAP_EDGE_Y * BUILD_TILE_HEIGHT) / BUILD_TILE_HEIGHT)
    return build_tile_y
