...
class Build_Tree:
    def __init__(self):
        ...
        self.tech[self.layer].append(Object_Build_BasicWarrior(self.position[0] + 3 * BUILD_TILE_WIDTH,
                                                               self.position[1] + 5 * BUILD_TILE_HEIGHT))
        self.tech[self.layer].append(Object_Build_BasicTent(self.position[0] + 5 * BUILD_TILE_WIDTH,
                                                            self.position[1] + 5 * BUILD_TILE_HEIGHT))
